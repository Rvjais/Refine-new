        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
            <div class="grid xl:grid-cols-2 gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <h2 class="text-section font-display text-brand-deeper mb-6 leading-[1.1]">What is <br/><i class="text-accent font-light">CO2 Laser Scar Removal in Kampala?</i></h2>
